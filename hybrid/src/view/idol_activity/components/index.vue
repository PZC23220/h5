<template>
    <div class="main">
         <div class="content">
            ...
            <p style="font-size:16px;color: #333;font-weight:600;margin-top:13px;">中国のファッション誌「可楽生活」に、上位1名の所属ユニットメンバー全員が特集ページに登場する！是非奮ってご参加ください！</p>
        ...
        data() {
            return {
                ...
                activity: {
                    ...
                    rule: {
                        title: '応募方法',
                        p1: '1. イベント期間中、「#可楽生活」タグをつけて投稿します。投稿内容は自由です。',
