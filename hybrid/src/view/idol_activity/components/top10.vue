            ...
            <ul class="ranking_list">
                <li>
                    ...
                    <div class="idol_desc">
                        ...
                        <p><span><img src="/img/timeline_icon_coins.png"><em>{{Number(ranking.length>0?(ranking[0].gcoin?ranking[0].gcoin:0):0).toLocaleString()}}</em></span><i>{{activity.Gcoin}}</i></p>
                        <p><span><img src="/img/timeline_icon_likes.png"><em>{{Number(ranking.length>0?(ranking[0].popularity?ranking[0].popularity:0):0).toLocaleString()}}</em></span><i>{{activity.like}}</i></p>
                    </div>
                    ...
                    <div class="idolranking_content">
                        ...
                        <div class="idol_content">
                            ...
                            <div class="idol_desc">
                                ...
                                <p><span><img src="/img/timeline_icon_coins.png"><em>{{Number(ranking.length>1?(ranking[1].gcoin?ranking[1].gcoin:0):0).toLocaleString()}}</em></span><i>{{activity.Gcoin}}</i></p>
                                <p><span><img src="/img/timeline_icon_likes.png"><em>{{Number(ranking.length>1?(ranking[1].popularity?ranking[1].popularity:0):0).toLocaleString()}}</em></span><i>{{activity.like}}</i></p>
                            </div>
                        </div>
                    </div>
