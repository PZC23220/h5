                     ...
                     <ul class="comment_list">
                        <!-- <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingListToday.rankingList?rakingListToday.rankingList[3].score || rakingListToday.rankingList[3].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingListToday.rankingList?rakingListToday.rankingList[3].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingListToday.rankingList?rakingListToday.rankingList[4].score || rakingListToday.rankingList[4].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingListToday.rankingList?rakingListToday.rankingList[4].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingListToday.rankingList?rakingListToday.rankingList[5].score || rakingListToday.rankingList[5].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingListToday.rankingList?rakingListToday.rankingList[5].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingListToday.rankingList?rakingListToday.rankingList[6].score || rakingListToday.rankingList[6].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingListToday.rankingList?rakingListToday.rankingList[6].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingListToday.rankingList?rakingListToday.rankingList[7].score || rakingListToday.rankingList[7].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingListToday.rankingList?rakingListToday.rankingList[7].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingListToday.rankingList?rakingListToday.rankingList[8].score || rakingListToday.rankingList[8].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingListToday.rankingList?rakingListToday.rankingList[8].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingListToday.rankingList?rakingListToday.rankingList[9].score || rakingListToday.rankingList[9].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingListToday.rankingList?rakingListToday.rankingList[9].score:'').toLocaleString()}}
                            </i>
                        </li> -->
                     ...
                     <ul class="comment_list">
                       <!--  <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingList.rankingList?rakingList.rankingList[3].score || rakingList.rankingList[3].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingList.rankingList?rakingList.rankingList[3].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingList.rankingList?rakingList.rankingList[4].score || rakingList.rankingList[4].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingList.rankingList?rakingList.rankingList[4].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingList.rankingList?rakingList.rankingList[5].score || rakingList.rankingList[5].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingList.rankingList?rakingList.rankingList[5].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingList.rankingList?rakingList.rankingList[6].score || rakingList.rankingList[6].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingList.rankingList?rakingList.rankingList[6].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingList.rankingList?rakingList.rankingList[7].score || rakingList.rankingList[7].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingList.rankingList?rakingList.rankingList[7].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingList.rankingList?rakingList.rankingList[8].score || rakingList.rankingList[8].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingList.rankingList?rakingList.rankingList[8].score:'').toLocaleString()}}
                            </i>
                        </li>
                        <li>
                            ...
                            <i class="con_left" :class="{'left_show':rakingList.rankingList?rakingList.rankingList[9].score || rakingList.rankingList[9].score==0:false}">
                                <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="">{{Number(rakingList.rankingList?rakingList.rankingList[9].score:'').toLocaleString()}}
                            </i>
                        </li> -->
