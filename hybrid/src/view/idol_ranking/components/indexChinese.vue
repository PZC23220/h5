            ...
            <swiper :options="swiperOption" ref="mySwiper" class="banner_container">
                ...
                <swiper-slide id="swiper1">
                    ...
                    <div class="help">
                        ...
                        <div class="rule_content">
                            <h4 @click="tottleFloor('a1')"><span></span>如何使用Groupy for Idol APP发精彩视频？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a1" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a2')"><span></span>Groupy是什么？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a2" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a3')"><span></span>爱豆要怎么上Groupy的人气榜？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a3" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a4')"><span></span>我如何在Groupy上首页？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a4" alt=""></h4>
                            <p v-show="isShow == 'a4'">
                            ...
                            <h4 @click="tottleFloor('a5')"><span></span>在Groupy发什么内容比较有趣受粉丝欢迎？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a5" alt=""></h4>
                            <p v-show="isShow == 'a5'">
                            ...
                            <h4 @click="tottleFloor('a6')"><span></span>加入Groupy以后我要如何获得粉丝?<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a6" alt=""></h4>
                            <p v-show="isShow == 'a6'">
                            ...
                            <h4 @click="tottleFloor('a7')"><span></span>如何通过Groupy迅速提高自己的知名度?<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a7" alt=""></h4>
                            <p v-show="isShow == 'a7'">
                            ...
                            <h4 @click="tottleFloor('a10')"><span></span>我是个人偶像！如何加入Groupy？？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a10" alt=""></h4>
                            <p v-show="isShow == 'a10'">
                ...
                <swiper-slide id="swiper2">
                    ...
                    <div class="help">
                        <h4>Groupy攻略</h4>
                        <div class="rule_content">
                            <h4 @click="tottleFloor('a11')"><span></span>如何使用Groupy for Idol APP发精彩视频？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a11" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a22')"><span></span>Groupy是什么？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a22" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a33')"><span></span>爱豆要怎么上Groupy的人气榜？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a33" alt=""></h4>
                            <p v-show="isShow == 'a33'">您好，Groupy小助理很高兴能为您解答。<br><br>Groupy的每日人气榜是根据爱豆每天当时的人气情况，从高到低排行。<br>可以有好多办法帮助提高人气：<br><br>1. 鼓励粉丝看视频不断点赞送人气 <br><br>2. 鼓励粉丝直接购买人气送给自己<br><br>3. 积极与粉丝互动，以及积极发布精彩视频，让粉丝应援和送礼物提高个人的人气值。<br>人气值最高的几位爱豆就可以登顶每日的人气top banner位置，另外还有历史最高排名可以查询。<br>总的来说，爱豆的每日人气都是根据粉丝的应援数决定的。应援越多，爱豆出现在人气榜上的可能性越大。<br><br><br>登顶Groupy人气榜可以得到什么呢？<br>1. 优先获得Groupy团队编辑筛选精彩视频发布到中国市场的机会。<br>2. 更多机会在日本和中国各大著名的粉丝宅男聚集地曝光宣传，如微博，bilibili，今日头条等平台。<br>3. 获得更多曝光和粉丝的应援。<br>想要了解更多，有问题也可以联系<i>idol@groupy.vip</i>邮箱哦</p>
                            <h4 @click="tottleFloor('a44')"><span></span>我如何在Groupy上首页？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a44" alt=""></h4>
                            <p v-show="isShow == 'a44'">
                                您好，Groupy小助理很高兴能为您解答。<br><br>Groupy的首页会展示爱豆上传的视频，视频的排行受上传的时间，人气情况，热度，打赏情况等影响，目的是给粉丝优先展示更新更受欢迎的视频。<br>所以如果想要获得Groupy首页的曝光，有好多方法可以实现的！<br><br>1. 积极更新免费和付费内容，通过发布精彩有趣的短视频，让Groupy的用户和粉丝为自己点赞送人气和礼物，越受欢迎的视频，就会优先排在首页上曝光<br><br>2.另一方面号召更多粉丝加入Groupy成为自己的会员，每天查看自己的最新动态，积累更多礼物和人气，让自己登顶人气榜<br><br>想要了解更多，马上加入Groupy申请成为爱豆，获得更多粉丝更多应援，实现自己的梦想吧！<br><br><a href="http://groupy.vip" target="_blank"> http://groupy.vip</a>
                            </p>
                            <h4 @click="tottleFloor('a55')"><span></span>在Groupy发什么内容比较有趣受粉丝欢迎？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a55" alt=""></h4>
                            <p v-show="isShow == 'a55'">
                                您好，Groupy小助理很高兴能为您解答。<br><br>Groupy首页的视频内容都是按照热度和粉丝的喜欢程度来排序的，越受欢迎的视频会优先展示给粉丝看到。要知道自己粉丝喜欢的内容可以通过几个方法实现：<br><br>1. 主动直接发起投票让粉丝选择想要看到的内容，吸引更多爱豆来应援自己，收货更多高级的铁杆粉丝。<br><br>2. 经过Groupy对粉丝的调研，发现粉丝会希望爱豆们定时更新自己的最新状态和行程以及能定时回复他们的留言，同步最近一些努力的成果，会让粉丝更加坚持地守护自己。<br><br>3.  首页上是根据发布时间，人气度，收获的礼物数量等经过编辑部筛选的精彩视频，可作参考<br><br>另外还可以经自己的更新内容分享至各大社交账号。只要内容被粉丝发现，就会被讨论，可以根据他们的意见来不断改进~希望爱豆可以早日发现有趣的内容，获得更多的应援，登上groupy的人气榜实现梦想！
                            </p>
                            <h4 @click="tottleFloor('a66')"><span></span>加入Groupy以后我要如何获得粉丝?<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a66" alt=""></h4>
                            <p v-show="isShow == 'a66'">
                                加入Groupy以后可以通过各种方法获得自己的粉丝：<br><br>1. 积极更新免费和付费内容，通过精彩的视频内容吸引Groupy的用户成为自己的粉丝，获得更多的人气，登顶人气榜（吸引更多新粉丝的非常非常有效的方法！）<br><br>2. 在自有的社交媒体Twitter和Facebook上宣传，让粉丝到Groupy关注和应援自己（最直接的方法！）<br><br>3. 在ameblo等博客网站发文吸引粉丝进驻（长期可积累更多忠实粉丝呢！）<br><br>4. Groupy会为每个进驻的爱豆在SNS上宣传以及在其他博客媒体告知粉丝的（Groupy会尽力为每位爱豆提高粉丝量的！）
                            </p>
                            <h4 @click="tottleFloor('a77')"><span></span>如何通过Groupy迅速提高自己的知名度?<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a77" alt=""></h4>
                            <p v-show="isShow == 'a77'">
                                您好，Groupy小助理很高兴能为您服务。<br><br>我们已经有很多爱豆在Groupy上经过自己的努力收获了大量粉丝，成为Groupy的明星爱豆，人气满满，希望你也能早日获得更高人气哦！现在为您分享一下如何通过Groupy迅速提高自己知名度的经验。<br><br>1. 一直一直一直强调也是最有效的方法就是：通过积极跟粉丝互动，了解他们的意愿，希望自己更新的内容种类和视频。积极发布能与粉丝互动性强的视频内容可以获得高价值的打赏和应援。不断收获粉丝的人气还可以竞争登上Groupy的每日人气榜，成为人气爱豆！<b>精彩视频还会通过Groupy官方编辑挑选发布到超过10亿用户的中国用户市场，包括宅男和粉丝最大的聚集地：微博，Bilibli，今日头条，微信公众号以及各大短视频相关的网站平台</b><br><br>2. 能够连续成为人气最高的爱豆，可以在极短的时间把Groupy的粉丝招揽成为自己的会员，支持和应援自己。<br><br>3. 每次在Groupy更新的免费内容都可以分享到社交媒体，借助Twitter，youtube和ameblo的社交力量，可以获得更多曝光，并且鼓励粉丝加入成为自己的会员可以迅速提高自己的知名度的！<br><br>以上是收集了明星爱豆的成长经验给大家分享，希望能够帮助爱豆们找到属于自己的舞台，达成自己的梦想！
                            </p>
                            <h4 @click="tottleFloor('a100')"><span></span>我是个人偶像！如何加入Groupy？？<img src="/img/idol_ranking/icon_arrow_gray_down.png" class="tottleimg a100" alt=""></h4>
