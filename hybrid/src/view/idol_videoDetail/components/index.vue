          ...
          <swiper :options="swiperOption" ref="mySwiper" class="banner_container">
            ...
            <swiper-slide id="swiper1">
                <div class="income eBorder">
                    ...
                    <span><img src="/img/timeline_icon_coins.png" alt="" class="icon"><i class="video_money" :class="{'video_money_show':(gcoinList.total || gcoinList.total == 0)}">{{gcoinList.total?Number(gcoinList.total).toLocaleString():0}}</i></span>
                </div>
                <div class="income_details eBorder">
                    ...
                    <ul class="income_img">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_star.png" alt="" style="background: #fffddd;">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_heart.png" alt="" style="background: #ffe7ea;">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_rose.png" alt="" style="background: #ffe9ec;">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_diamond.png" alt="" style="background: #e1eff2;">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_bear.png" alt="" style="background: #fff1e2;">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_tree.png" alt="" style="background: #ffedf1;">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_tower.png" alt="" style="background: #ffe9ea;">
                        ...
                        <li>
                            <img class="gift" src="/img/gift/pic_castle.png" alt="" style="background: #dbe6f6;">
