            ...
            <swiper-slide id="swiper1">
                ...
                <div class="income_details eBorder">
                    ...
                    <ul class="income_img">
                        ...
                        <li>
                            <img class="gift" src="http://h2.groupy.vip/groupy_h5/gift/pic_star.png" alt="" style="background: #fffddd;">
                        ...
                        <li>
                            <img class="gift" src="http://h2.groupy.vip/groupy_h5/gift/pic_heart.png" alt="" style="background: #ffe7ea;">
                        ...
                        <li>
                            <img class="gift" src="http://h2.groupy.vip/groupy_h5/gift/pic_rose.png" alt="" style="background: #ffe9ec;">
                        ...
                        <li>
                            <img class="gift" src="http://h3.groupy.vip/groupy_h5/gift/pic_diamond.png" alt="" style="background: #e1eff2;">
                        ...
                        <li>
                            <img class="gift" src="http://h3.groupy.vip/groupy_h5/gift/pic_bear.png" alt="" style="background: #fff1e2;">
                        ...
                        <li>
                            <img class="gift" src="http://h3.groupy.vip/groupy_h5/gift/pic_tree.png" alt="" style="background: #ffedf1;">
                        ...
                        <li>
                            <img class="gift" src="http://h4.groupy.vip/groupy_h5/gift/pic_tower.png" alt="" style="background: #ffe9ea;">
                        ...
                        <li>
                            <img class="gift" src="http://h4.groupy.vip/groupy_h5/gift/pic_castle.png" alt="" style="background: #dbe6f6;">
                    ...
                    <ul class="comment_list">
                        <li v-for="(fans,key) in gcoinList.rank" >
                            <!-- <left-slider :index="key" @deleteItem="deleteItem(fans.fansId)"> -->
                                <span class="level_color" v-if="key == 0"><img src="http://h1.groupy.vip/groupy_h5/crown_metal/icon_metal_1.png" alt=""></span>
                                <span class="level_color" v-if="key == 1"><img src="http://h1.groupy.vip/groupy_h5/crown_metal/icon_metal_2.png" alt=""></span>
                                <span class="level_color" v-if="key == 2"><img src="http://h1.groupy.vip/groupy_h5/crown_metal/icon_metal_3.png" alt=""></span>
                ...
                <ul class="comment_list" style="padding: 0;min-height: calc(100vh - 41px);">
                    <li v-for="(popularity,key) in popularityList" >
                        <!-- <left-slider :index="key" @deleteItem="deleteItem(popularity.fansId)"> -->
                            ...
                            <img class="medal_level" :src="'http://h1.groupy.vip/groupy_h5/medal/icon_medal_'+(popularity.userFans.medal)+'.png'" v-if="popularity.userFans.medal&&popularity.userFans.medal>0" alt="">
                            <i>
                                <img src="http://h4.groupy.vip/groupy_h5/icon/timeline_icon_likes.png" class="likes" alt="">{{popularity.totalNums?Number(popularity.totalNums).toLocaleString():'0'}}
                            </i>
                        <!-- </left-slider> -->
                    </li>
                </ul>
                    ...
                    <ul class="comment_list" style="background: #fff;min-height: calc(100vh - 41px);">
                        <li v-for="(comment,key) in commentList" :class="[{'lastLi' : commentList.length > 5 && key == commentList.length-1},{'firstLi' : key == 0}]">
                            <div class="comment_info">
                                ...
                                <img class="medal_level" style="margin-top: 0px;" :src="'http://h1.groupy.vip/groupy_h5/medal/icon_medal_'+(comment.medal)+'.png'" v-if="comment.medal&&comment.medal>0" alt="">
