    ...
    <div class="main">
       <div class="content" style="top:0;height: 100vh;">
            ...
            <div class="video_details">
                ...
                <span class="video_gcoins"><img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="" class="icon"> <i class="video_money" :class="{'video_money_show':(gcoinList.total || gcoinList.total == 0)}">{{gcoinList.total?Number(gcoinList.total).toLocaleString():0}}</i></span>
...
<script>
    ...
    export default {
        ...
        methods: {
            videoMuted() {
                if(this.isMuted == 'http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/video_icon_voice_on.png') {
                    this.isMuted = 'http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/video_icon_voice_off.png'
                }else {
                    this.isMuted = 'http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/video_icon_voice_on.png'
                }
