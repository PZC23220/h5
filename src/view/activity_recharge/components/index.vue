<template>
    <div class="main">
         <div class="content">
            <img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/banner-recharge.jpg" class="banner">
            <!-- <h2>{{activity.theme}}</h2> -->
            <div class="activity_time">
                <p class="share-sns" v-if="false"><span @click="shareSns('share_facebook')"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/sns/icon_facebook_1.png"><i>シェア</i></span><span @click="shareSns('share_twitter')"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/sns/icon_twitter_1.png"><i>ツイート</i></span></p>
                <h4>{{activity.time}}</h4>
        ...
        methods: {
            shareSns(val) {
                ...
                if(location.hostname == 'h5.groupy.vip') {
                    var shareURL = `https://share.groupy.vip/html/activity_recharge/index.html`;
                }else {
                    var shareURL = `https://share.groupy.cn/html/activity_recharge/index.html`;
                }
                var title = `コイン倍増キャンペーン`;
                var description = `Groupyで購入したコインはもれなく100%増量！チャンスをつかんでコインを沢山手に入れよう...`;
                var shareImg = `https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/optupload/%E5%85%85%E5%80%BC.jpg`;
