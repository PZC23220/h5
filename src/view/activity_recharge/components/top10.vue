<template>
    <div class="main">
        <div class="content">
            <img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/acticity_banner/banner-coke.jpg" class="banner">
            ...
            <ul class="ranking_list">
                <li>
                    <div class="img_content">
                        ...
                        <img v-lazy="ranking.length>0?ranking[0].avatar:'https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/default_img/default_img.png'" class="avatar">
                    ...
                    <div class="idol_desc">
                        <!-- <p><span><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png"><em>{{Number(ranking.length>0?(ranking[0].gcoin?ranking[0].gcoin:0):0).toLocaleString()}}</em></span><i>{{activity.Gcoin}}</i></p> -->
                ...
                <!-- <li>
                    <div class="idolranking_content">
                        <div class="img_content">
                            <img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/crown_metal/icon_crown_2.png" class="crown">
                            <img v-lazy="ranking.length>1?ranking[1].avatar:'https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/default_img/default_img.png'" class="avatar">
                        ...
                        <div class="idol_content">
                            ...
                            <div class="idol_desc">
                                <p><span><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png"><em>{{Number(ranking.length>1?(ranking[1].popularity?ranking[1].popularity:0):0).toLocaleString()}}</em></span></p>
...
<style rel="stylesheet/scss" lang="scss" scoped>
    ...
    .ranking_list {
        ...
        li:first-child {
            background-image: url(https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/activity/pic_1.png);
