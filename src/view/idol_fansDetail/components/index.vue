        ...
        <div class="header" style="border-bottom: 1px solid #eee;">
            <div class="income eBorder">
                <p>
                    ...
                    <span class="detail_gcoin"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/icon_fans%20.png" alt="" class="icon"><i class="video_money left" :class="{'left_show':joinList.fansCount || joinList.fansCount == 0}">{{joinList.fansCount?Number(joinList.fansCount).toLocaleString():0}}</i></span>
                </p>
                <p>
                    <span class="detail_title">{{fans_text.add}}</span>
                    <span class="detail_gcoin"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/icon_fans%20.png" alt="" class="icon"><i class="video_money left" :class="{'left_show':joinList.fansIncreased || joinList.fansIncreased == 0}">{{joinList.fansIncreased?Number(joinList.fansIncreased).toLocaleString():0}}</i></span>
                </p>
            </div>
                ...
                <ul class="comment_list">
                    <li v-for="(gFans,key) in gcoinList.fansList">
                        <!-- <left-slider :index="key" @deleteItem="deleteItem(gFans.userFansId)"> -->
                            ...
                            <!-- <img :src="gFans.fans?'/static/images/icon_level_'+(gFans.fans.levelPlatform)+'.png':'https://h5.groupy.vip/static/images/icon_level_0.png'" onerror="this.src='https://h5.groupy.vip/static/images/icon_level_0.png'" class="level" alt=""> -->
        ...
        methods: {
            ...
            getJoin(token) {
                ...
                if(self.idx1 < 1) {
                    ...
                    http.get('/statistic/time?filter=basic').then(function(res){
                        if(res.status == 200) {
            ...
            getPopularity(token) {
                ...
                if(self.idx2 < 1) {
                    ...
                    http.get('/statistic/heat?filter=basic').then(function(res){
                        if(res.status == 200) {
