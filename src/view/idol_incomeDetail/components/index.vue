        ...
        <div class="content" style=" top: 0;">
            <div class="income eBorder">
                <p>
                    ...
                    <span class="detail_gcoin" style="height: 27px;overflow: hidden;"><img src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png" alt="" class="icon"><i class="video_money left" :class="{'left_show':incomeList.incomeCurrentMonth || incomeList.incomeCurrentMonth == 0}">{{incomeList.incomeCurrentMonth?Number(incomeList.incomeCurrentMonth).toLocaleString():0}}</i></span>
                </p>
                <p>
            ...
            <div class="income_details eBorder">
                ...
                <ul class="income_img">
                    <li>
                        <img class="gift" src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/member/pic_vip_free.png" alt="">
                    ...
                    <li>
                        <img class="gift" src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/member/pic_vip_1%20month.png" alt="">
                    ...
                    <li>
                        <img class="gift" src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/member/pic_vip_3%20month.png" alt="">
                    ...
                    <li>
                        <img class="gift" src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/member/pic_vip_6%20month.png" alt="">
             ...
             <div class="mention_details">
                ...
                <ul class="mention_list">
                    ...
                    <li v-for="(record,key) in incomeList.monthRecordList">
                        ...
                        <p><img src="http://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png" class="icon" alt=""><b>{{Number(record.gcoins).toLocaleString()}}</b></p>
