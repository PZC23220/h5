<template>
    <div class="main">
         <div class="content">
            <div class="page_loading" :class="{'page_loading_show':tasks.length > 0}">
                <div class="task">
                    <div class="task_content">
                        ...
                        <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/icon_finish.png" v-show="false">
                    </div>
                    <div class="reward"><i>{{task_test.reward}}</i><span><img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png">0</span><span>{{task_test.receive}}</span></div>
                </div>
                <div class="task">
                    <div class="task_content">
                        <h5></h5>
            ...
            <div class="task" v-for="task in tasks">
                <div class="task_content">
                    ...
                    <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/icon_finish.png" v-show="task.complete>0">
                </div>
                <div class="reward"><i>{{task_test.reward}}</i><span><img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png">{{task.gprice}}</span><span :class="{'finish':(task.complete>0 && task.accepted<1)}" @click="(task.complete>0 && task.accepted<1)?accept(task.id,task.gprice,$event):false">{{status(task.accepted)}}</span></div>
            </div>
         </div>
         <div class="receive_coin" :class="{'receive_coin_show':receiveShow}">
             ...
             <img src="http://photodebug.oss-cn-hongkong.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png">
         </div>
    </div>
</template>
<script>
