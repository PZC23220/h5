            ...
            <swiper :options="swiperOption" ref="mySwiper" class="banner_container">
                ...
                <swiper-slide id="swiper1">
                    ...
                    <div class="integral con_left" :class="{'left_hide':rakingListTodaymeShow}">
                        <p style="text-align: left;padding: 0;"><span>自分の順位</span><span><i>-位</i><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt=""><i>0</i></span></p>
                    </div>
                    <div class="integral" v-if="rakingListTodayme.length>0">
                       <p><span>自分の順位</span><span><i>{{rakingListTodayme.length>0?rakingListTodayme[0].position:'-'}}位</i><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt=""><i>{{Number(rakingListTodayme.length>0?rakingListTodayme[0].score:'0').toLocaleString()}}</i></span></p>
                    ...
                    <div class="help">
                        ...
                        <div class="rule_content">
                            <h4 @click="tottleFloor('a1')"><span></span><em>Groupy for Idol APPでは、どうやって動画を投稿しますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a1" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a2')"><span></span><em>Groupyとは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a2" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a3')"><span></span><em>ランキング上位に入るコツは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a3" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a4')"><span></span><em>投稿した動画はどうすればホームページの上に行きますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a4" alt=""></h4>
                            <p v-show="isShow == 'a4'">
                                Groupyは、ホームページにアイドルの投稿した動画を載せます。より多く見られ、「いいね」「ギフティング」される動画が上に行きますので、下記の方法がオススメです。<br><br><b>1.積極的に動画を投稿し、ファンの応援をお願いする</b><br><b>2.工夫した動画ほど、「いいね」「ギフティング」されやすい</b><br><br>＃動画の並び順番は投稿時間、人気度、ギフト数などで決まります。<br><br>詳しくは公式サイトからご覧下さい～<a href="https://groupy.vip" target="_blank"> --- <i>https://groupy.vip</i></a>
                            </p>
                            <h4 @click="tottleFloor('a5')"><span></span><em>何を投稿すればいいますか。/どんな投稿がおすすめですか</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a5" alt=""></h4>
                            <p v-show="isShow == 'a5'">
                            ...
                            <h4 @click="tottleFloor('a6')"><span></span><em>Groupyで稼いだコインは換金できますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a6" alt=""></h4>
                            <p v-show="isShow == 'a6'">
                            ...
                            <h4 @click="tottleFloor('a7')"><span></span><em>Groupyでコインを結構貯めたが、現金に換金できますかな。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a7" alt=""></h4>
                            <p v-show="isShow == 'a7'">
                ...
                <swiper-slide id="swiper2">
                    ...
                    <div class="integral" v-if="rakingListWeekme.length>0">
                       <p><span>自分の順位</span><span><i>{{rakingListWeekme.length>0?rakingListWeekme[0].position:'-'}}位</i><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt=""><i>{{Number(rakingListWeekme.length>0?rakingListWeekme[0].score:'0').toLocaleString()}}</i></span></p>
                    ...
                    <div class="help">
                        <h4>Groupyの人気者になる秘訣を今キャッチ！</h4>
                        <div class="rule_content">
                            <h4 @click="tottleFloor('a111')"><span></span><em>Groupy for Idol APPでは、どうやって動画を投稿しますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a111" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a222')"><span></span><em>Groupyとは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a222" alt=""></h4>
                            <p v-show="isShow == 'a222'"><b>Groupyは、動画・掲示板など様々な機能を通じて濃いファンをマネジメントし、オンラインでマネタイズできるアプリです。</b><br>動画をたくさん投稿することで、注目を集め、入会してもらい、さらに掲示板・生配信・ストアなどを通じて会員と交流し、いっぱい応援もらいます。<br><br> <b>中国のファンに配信できる唯一のアプリです。</b><br>Groupyは日本だけではなく、中国・香港・台湾にも配信します。海外のファンと交流できる唯一のアプリであり、中国でライブすることも実現できるかもよ。<br><br>Groupyで注目を集め、ファンたちとのコミュニティーを作り、いっぱい応援してもらって、そこからたくさんの可能性が生まれてきます。ぜひ夢を叶えるプラットフォームとしてご活用ください。</p>


                            <h4 @click="tottleFloor('a333')"><span></span><em>ランキング上位に入るコツは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a333" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a444')"><span></span><em>投稿した動画はどうすればホームページの上に行きますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a444" alt=""></h4>
                            <p v-show="isShow == 'a444'">
                                Groupyは、ホームページにアイドルの投稿した動画を載せます。より多く見られ、「いいね」「ギフティング」される動画が上に行きますので、下記の方法がオススメです。<br><br><b>1.積極的に動画を投稿し、ファンの応援をお願いする</b><br><b>2.工夫した動画ほど、「いいね」「ギフティング」されやすい</b><br><br>＃動画の並び順番は投稿時間、人気度、ギフト数などで決まります。<br><br>詳しくは公式サイトからご覧下さい～<a href="https://groupy.vip" target="_blank"> --- <i>https://groupy.vip</i></a>
                            </p>
                            <h4 @click="tottleFloor('a555')"><span></span><em>何を投稿すればいいますか。/どんな投稿がおすすめですか</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a555" alt=""></h4>
                            <p v-show="isShow == 'a555'">
                                SNSでは公開しない一面を表現した動画がオススメです。<br>なお、ファンたちはどうのような動画が好きかは下記の方法で調べておこう。<br>1.<b>掲示板</b>を活用して投票を行い、ファンに直接聞く。<br>2.<b>ホームページ</b>上位の人気動画を参考する<br>3.自分の投稿をTwitter，Ameba等の<b>SNSに共有し</b>、コメントをもらう！</p>


                            <h4 @click="tottleFloor('a666')"><span></span><em>Groupyで稼いだコインは換金できますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a666" alt=""></h4>
                            <p v-show="isShow == 'a666'">
                                できます。<br>Groupyは、アイドルの稼いだコインを一定の比率で還元しています。<br><br>詳しくはアイドル専用のGroupy-idol アプリの決済詳細ページをご覧下さい～<br>詳しくは「idol@groupy.vip」までお問い合わせください。
                            </p>


                            <h4 @click="tottleFloor('a777')"><span></span><em>Groupyでコインを結構貯めたが、現金に換金できますかな。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a777" alt=""></h4>
                ...
                <swiper-slide id="swiper3">
                    ...
                    <div class="integral" v-if="rakingListMonthme.length>0">
                       <p><span>自分の順位</span><span><i>{{rakingListMonthme.length>0?rakingListMonthme[0].position:'-'}}位</i><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt=""><i>{{Number(rakingListMonthme.length>0?rakingListMonthme[0].score:'0').toLocaleString()}}</i></span></p>
                    ...
                    <div class="help">
                        <h4>Groupyの人気者になる秘訣を今キャッチ！</h4>
                        <div class="rule_content">
                            <h4 @click="tottleFloor('a1111')"><span></span><em>Groupy for Idol APPでは、どうやって動画を投稿しますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a1111" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a2222')"><span></span><em>Groupyとは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a2222" alt=""></h4>
                            <p v-show="isShow == 'a2222'"><b>Groupyは、動画・掲示板など様々な機能を通じて濃いファンをマネジメントし、オンラインでマネタイズできるアプリです。</b><br>動画をたくさん投稿することで、注目を集め、入会してもらい、さらに掲示板・生配信・ストアなどを通じて会員と交流し、いっぱい応援もらいます。<br><br> <b>中国のファンに配信できる唯一のアプリです。</b><br>Groupyは日本だけではなく、中国・香港・台湾にも配信します。海外のファンと交流できる唯一のアプリであり、中国でライブすることも実現できるかもよ。<br><br>Groupyで注目を集め、ファンたちとのコミュニティーを作り、いっぱい応援してもらって、そこからたくさんの可能性が生まれてきます。ぜひ夢を叶えるプラットフォームとしてご活用ください。</p>


                            <h4 @click="tottleFloor('a3333')"><span></span><em>ランキング上位に入るコツは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a3333" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a4444')"><span></span><em>投稿した動画はどうすればホームページの上に行きますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a4444" alt=""></h4>
                            <p v-show="isShow == 'a4444'">
                                Groupyは、ホームページにアイドルの投稿した動画を載せます。より多く見られ、「いいね」「ギフティング」される動画が上に行きますので、下記の方法がオススメです。<br><br><b>1.積極的に動画を投稿し、ファンの応援をお願いする</b><br><b>2.工夫した動画ほど、「いいね」「ギフティング」されやすい</b><br><br>＃動画の並び順番は投稿時間、人気度、ギフト数などで決まります。<br><br>詳しくは公式サイトからご覧下さい～<a href="https://groupy.vip" target="_blank"> --- <i>https://groupy.vip</i></a>
                            </p>
                            <h4 @click="tottleFloor('a5555')"><span></span><em>何を投稿すればいいますか。/どんな投稿がおすすめですか</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a5555" alt=""></h4>
                            <p v-show="isShow == 'a5555'">
                                SNSでは公開しない一面を表現した動画がオススメです。<br>なお、ファンたちはどうのような動画が好きかは下記の方法で調べておこう。<br>1.<b>掲示板</b>を活用して投票を行い、ファンに直接聞く。<br>2.<b>ホームページ</b>上位の人気動画を参考する<br>3.自分の投稿をTwitter，Ameba等の<b>SNSに共有し</b>、コメントをもらう！</p>


                            <h4 @click="tottleFloor('a6666')"><span></span><em>Groupyで稼いだコインは換金できますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a6666" alt=""></h4>
                            <p v-show="isShow == 'a6666'">
                                できます。<br>Groupyは、アイドルの稼いだコインを一定の比率で還元しています。<br><br>詳しくはアイドル専用のGroupy-idol アプリの決済詳細ページをご覧下さい～<br>詳しくは「idol@groupy.vip」までお問い合わせください。
                            </p>


                            <h4 @click="tottleFloor('a7777')"><span></span><em>Groupyでコインを結構貯めたが、現金に換金できますかな。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a7777" alt=""></h4>
                ...
                <swiper-slide id="swiper4">
                    ...
                    <div class="integral" v-if="rakingListme.length>0">
                       <p><span>自分の順位</span><span><i>{{rakingListme.length>0?rakingListme[0].position:'-'}}位</i><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt=""><i>{{Number(rakingListme.length>0?rakingListme[0].score:'0').toLocaleString()}}</i></span></p>
                    ...
                    <div class="help">
                        <h4>Groupyの人気者になる秘訣を今キャッチ！</h4>
                        <div class="rule_content">
                            <h4 @click="tottleFloor('a11')"><span></span><em>Groupy for Idol APPでは、どうやって動画を投稿しますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a11" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a22')"><span></span><em>Groupyとは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a22" alt=""></h4>
                            <p v-show="isShow == 'a22'"><b>Groupyは、動画・掲示板など様々な機能を通じて濃いファンをマネジメントし、オンラインでマネタイズできるアプリです。</b><br>動画をたくさん投稿することで、注目を集め、入会してもらい、さらに掲示板・生配信・ストアなどを通じて会員と交流し、いっぱい応援もらいます。<br><br> <b>中国のファンに配信できる唯一のアプリです。</b><br>Groupyは日本だけではなく、中国・香港・台湾にも配信します。海外のファンと交流できる唯一のアプリであり、中国でライブすることも実現できるかもよ。<br><br>Groupyで注目を集め、ファンたちとのコミュニティーを作り、いっぱい応援してもらって、そこからたくさんの可能性が生まれてきます。ぜひ夢を叶えるプラットフォームとしてご活用ください。</p>


                            <h4 @click="tottleFloor('a33')"><span></span><em>ランキング上位に入るコツは何ですか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a33" alt=""></h4>
                            ...
                            <h4 @click="tottleFloor('a44')"><span></span><em>投稿した動画はどうすればホームページの上に行きますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a44" alt=""></h4>
                            <p v-show="isShow == 'a44'">
                                Groupyは、ホームページにアイドルの投稿した動画を載せます。より多く見られ、「いいね」「ギフティング」される動画が上に行きますので、下記の方法がオススメです。<br><br><b>1.積極的に動画を投稿し、ファンの応援をお願いする</b><br><b>2.工夫した動画ほど、「いいね」「ギフティング」されやすい</b><br><br>＃動画の並び順番は投稿時間、人気度、ギフト数などで決まります。<br><br>詳しくは公式サイトからご覧下さい～<a href="https://groupy.vip" target="_blank"> --- <i>https://groupy.vip</i></a>
                            </p>
                            <h4 @click="tottleFloor('a55')"><span></span><em>何を投稿すればいいますか。/どんな投稿がおすすめですか</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a55" alt=""></h4>
                            <p v-show="isShow == 'a55'">
                                SNSでは公開しない一面を表現した動画がオススメです。<br>なお、ファンたちはどうのような動画が好きかは下記の方法で調べておこう。<br>1.<b>掲示板</b>を活用して投票を行い、ファンに直接聞く。<br>2.<b>ホームページ</b>上位の人気動画を参考する<br>3.自分の投稿をTwitter，Ameba等の<b>SNSに共有し</b>、コメントをもらう！</p>


                            <h4 @click="tottleFloor('a66')"><span></span><em>Groupyで稼いだコインは換金できますか。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a66" alt=""></h4>
                            <p v-show="isShow == 'a66'">
                                できます。<br>Groupyは、アイドルの稼いだコインを一定の比率で還元しています。<br><br>詳しくはアイドル専用のGroupy-idol アプリの決済詳細ページをご覧下さい～<br>詳しくは「idol@groupy.vip」までお問い合わせください。
                            </p>


                            <h4 @click="tottleFloor('a77')"><span></span><em>Groupyでコインを結構貯めたが、現金に換金できますかな。</em><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/arrow/icon_arrow_gray_down.png" class="tottleimg a77" alt=""></h4>
                            <p v-show="isShow == 'a77'">
                                こんにちは、Groupyです。<br>コインをいっぱい貯められて、誠におめでとうございまーす。<br><br><b>Groupyは、アイドルのコインの獲得数によって予め約束した割合で金額決済を行い、決まった日にアイドルの口座に振込みます。</b><br><br>詳しくはアイドル専用のGroupy-idol アプリの収入詳細の説明ページをご覧下さい～
                            </p>
                        </div>
