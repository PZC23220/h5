    ...
    <div class="main">
       <div class="content" v-if="!reply">
            ...
            <div class="video_content">
                ...
                <img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/icon_play.png" class="video_play" v-if="videoPlay" @click="videoPlayed()">
                <img :src="isMuted" class="video_muted" @click="videoMuted()">
            </div>
            <div class="video_details">
                <span class="video_gcoins"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png" alt="" class="icon"> <i class="video_money" :class="{'video_money_show':(gcoinList.total || gcoinList.total == 0)}">{{gcoinList.total?Number(gcoinList.total).toLocaleString():0}}</i></span>
                <span class="video_gcoins"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" alt="" class="icon"> <i class="video_money" :class="{'video_money_show':(gcoinList.totalPopularity || gcoinList.totalPopularity == 0)}">{{gcoinList.totalPopularity?Number(gcoinList.totalPopularity).toLocaleString():0}}</i></span>
                <span class="video_comments" v-show='false' @click="add_reply(comment)"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/icon_comment.png"><i>コメントする</i></span>
            </div>
          ...
          <swiper :options="swiperOption" ref="mySwiper" class="banner_container">
                    ...
                    <ul class="comment_list" style="background: #eee;">
                        <li v-for="(comment,key) in commentList" :class="[{'lastLi' : commentList.length > 5 && key == commentList.length-1},{'firstLi' : key == 0}]">
                            <div class="comment_info">
                                ...
                                <!-- <img class="level" :src="'/static/images/icon_level_'+(comment.levelPlatform)+'.png'" onerror="this.src='https://h5.groupy.vip/static/images/icon_level_0.png'" alt=""> -->
                            ...
                            <div class="reply"><span v-html="formatTime(comment.createTime)"></span><span @click="add_reply(comment)"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/icon_comment_blue.png"><em>{{video_text.reply}}</em></span></div>
                        </li>
            ...
            <swiper-slide id="swiper2">
                <!-- <div class="income eBorder">
                    ...
                    <span><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png" alt="" class="icon"><i class="video_money" :class="{'video_money_show':(gcoinList.total || gcoinList.total == 0)}">{{gcoinList.total?Number(gcoinList.total).toLocaleString():0}}</i></span>
                </div> -->
                            ...
                            <ul class="comment_list">
                                <li v-for="(fans,key) in gcoinList.rank" >
                                    <!-- <left-slider :index="key" @deleteItem="deleteItem(fans.fansId)"> -->
                                        <span class="level_color" v-if="key == 0"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/crown_metal/icon_metal_1.png" alt=""></span>
                                        <span class="level_color" v-if="key == 1"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/crown_metal/icon_metal_2.png" alt=""></span>
                                        <span class="level_color" v-if="key == 2"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/crown_metal/icon_metal_3.png" alt=""></span>
                                        ...
                                        <!-- <img :src="fans.userFans?('/static/images/icon_level_'+ (fans.userFans.levelPlatform) +'.png'): '/static/images/icon_level_0.png'" onerror="this.src='https://h5.groupy.vip/static/images/icon_level_0.png'" class="level" alt=""> -->
                                        ...
                                        <img class="medal_level" :src="'https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/medal/icon_medal_'+(fans.userFans.medal)+'.png'" v-if="fans.userFans.medal&&fans.userFans.medal>0" alt="">
                                        <i>
                                            <img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_coins.png" class="likes" alt="">{{fans.expendGprice?Number(fans.expendGprice).toLocaleString(): 0}}
                                        </i>
                                    <!-- </left-slider> -->
                                </li>
                            ...
                            <ul class="comment_list" style="padding: 0;">
                                <li v-for="(popularity,key) in popularityList" >
                                    <!-- <left-slider :index="key" @deleteItem="deleteItem(popularity.fansId)"> -->
                                        ...
                                        <img class="medal_level" :src="'https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/medal/icon_medal_'+(popularity.userFans.medal)+'.png'" v-if="popularity.userFans.medal&&popularity.userFans.medal>0" alt="">
                                        <i>
                                            <img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/icon/timeline_icon_likes.png" class="likes" alt="">{{popularity.totalNums?Number(popularity.totalNums).toLocaleString():'0'}}
                                        </i>
                                    <!-- </left-slider> -->
                                </li>
        ...
        <div class="reply_container" v-if="reply">
            <div class="reply_header"><img src="https://photoh5-jp.oss-ap-northeast-1.aliyuncs.com/h5_groupy/close/close.png" @click="reply = false">{{video_text.reply}}<span @click="reply_submit()">{{video_text.submit}}</span></div>
