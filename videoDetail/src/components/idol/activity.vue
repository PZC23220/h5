                ...
                <ul class="ranking_list">
                    <div class="none_loading" :class="{'none_loading_show': loadingShow}">
                        <li>
                            ...
                            <div class="img_content"><img src="../../images/default_img.png" class="avatar"><img src="../../images/icon_crown_1.png" class="crown"></div>
                            <div class="idol_content">
                                ...
                                <div class="idol_desc">
                                    ...
                                    <p><span><img src="../../images/timeline_icon_coins.png"><em>0</em></span><i>{{activity.Gcoin}}</i></p>
                                    <p><span><img src="../../images/timeline_icon_likes.png"><em>0</em></span><i>{{activity.like}}</i></p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <span class="second">2</span>
                            <div class="img_content"><img src="../../images/default_img.png" class="avatar"><img src="../../images/icon_crown_2.png" class="crown"></div>
                            <div class="idol_content">
                                <span>idolName</span>
                                <div class="idol_desc">
                                    <p><span style="text-align: left;margin-left: 10px;"><em>0</em></span><i style="text-align: left;margin-left: -5px;">{{activity.works}}</i></p>
                        ...
                        <li>
                            ...
                            <div class="img_content"><img src="../../images/default_img.png" class="avatar"><img src="../../images/icon_crown_3.png" class="crown"></div>
                            <div class="idol_content">
                                <span>idolName</span>
                                <div class="idol_desc">
                                    <p><span style="text-align: left;margin-left: 10px;"><em>0</em></span><i style="text-align: left;margin-left: -5px;">{{activity.works}}</i></p>
                    ...
                    <li v-if="me.ranking">
                        ...
                        <div class="img_content"><img :src="me.avatar?me.avatar:'../../images/default_img.png'" onerror="this.src='http://h5.groupy.vip/static/images/default_img.png'" class="avatar"><img src="../../images/icon_crown_1.png" class="crown" v-if="me.ranking?me.ranking==1:false"><img src="../../images/icon_crown_2.png" class="crown" v-if="me.ranking?me.ranking==2:false"><img src="../../images/icon_crown_3.png" class="crown" v-if="me.ranking?me.ranking>2:false"></div>
                        <div class="idol_content">
                            ...
                            <div class="idol_desc">
                                ...
                                <p><span><img src="../../images/timeline_icon_coins.png"><em>{{Number(me.gcoin?me.gcoin:0).toLocaleString()}}</em></span><i>{{activity.Gcoin}}</i></p>
                                <p><span><img src="../../images/timeline_icon_likes.png"><em>{{Number(me.popularity?me.popularity:0).toLocaleString()}}</em></span><i>{{activity.like}}</i></p>
                            </div>
                        </div>
                    </li>
                    <h5>{{activity.all}}</h5>
                    <li v-for="(idol,key) in ranking" v-if="key < 3">
                        ...
                        <div class="img_content"><img :src="idol.avatar?idol.avatar:'../../images/default_img.png'" onerror="this.src='http://h5.groupy.vip/static/images/default_img.png'" class="avatar"><img src="../../images/icon_crown_1.png" class="crown" v-if="idol.ranking?idol.ranking==1:false"><img src="../../images/icon_crown_2.png" class="crown" v-if="idol.ranking?idol.ranking==2:false"><img src="../../images/icon_crown_3.png" class="crown" v-if="idol.ranking?idol.ranking>2:false"></div>
                        <div class="idol_content">
                    ...
                    <router-link to="/idol/activity_top10" class="reard_more">{{activity.more}}</router-link>
                </ul>
            </div>
            <ul class="activity_reward">
                <h4>{{activity.award}}</h4>
                <li>
                    <img src="../../images/activity/icon_1.png">
                ...
                <li>
                    <img src="../../images/activity/icon_2.png">
                    <div class="reward_desc">
                ...
                <li>
                    <img src="../../images/activity/icon_3.png">
                    <div class="reward_desc">
