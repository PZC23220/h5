                ...
                <swiper-slide id="swiper1">
                    ...
                    <div class="help">
                        ...
                        <div class="rule_content">
                            ...
                            <p v-show="isShow == 2">こんにちは、Groupyです。<br>いつもご利用頂き、誠にありがとうございます。<br><br> Groupyは、ファンが共にアイドルを応援できるメンバーシップ制アプリです。<br>ひと押しだけで応援できて、アイドルの成長をより身近に見守れて、更にメンバーのみの限定情報をいっぱい入手できます。アイドルとファンを親密につなぐプラットフォームを作ろうとしています。<br><br>ファンが、アイドル自身のスマホから投稿した面白い動画をリアルタイムでチェックできます。<br>アイドルの会員になって、掲示板で応援メッセージが送信できます。更に、最新オフ会情報やアイドルの日常、オフショットをいち早く入手！<br><br>アイドルは、ファンを集めるコミュニティを作って夢を叶えます！Groupyで動画を投稿して、「公開」か「会員のみ」のプライバシー設定してファンにシェアできます。ファンから有力な応援をもらい、ランキングの上位に入って注目度を上げましょう！</p>
                ...
                <swiper-slide id="swiper2">
                    ...
                    <div class="help">
                        ...
                        <div class="rule_content">
                            ...
                            <p v-show="isShow == 11">こんにちは、Groupyです。<br><br>いつもご利用頂き、誠にありがとうございます。<br><br><b>Groupy for Idol Appで動画を投稿することは、アイドルの専用機能です。</b><br><br><b>アイドルは、アイドル専用のGroupy-idol アプリをダウンロードして、アプリで録画して投稿することができます。</b><br><br>また、Groupyではメンバーシップ制がありますので、アイドルが自分の動画に「公開」と「会員のみ」の二つのプライバシー設定を選べます。しかし、ギャラリーからアップロードした動画の再生時間は10分までという制限がありますので、気をつけてください。</p>
                            <h4 @click="tottleFloor(22)"><span></span><em>Groupyとは何ですか。</em><img :src="tottleImg" alt=""></h4>
                            <p v-show="isShow == 22">こんにちは、Groupyです。<br>いつもご利用頂き、誠にありがとうございます。<br><br> Groupyは、ファンが共にアイドルを応援できるメンバーシップ制アプリです。<br>ひと押しだけで応援できて、アイドルの成長をより身近に見守れて、更にメンバーのみの限定情報をいっぱい入手できます。アイドルとファンを親密につなぐプラットフォームを作ろうとしています。<br><br>ファンが、アイドル自身のスマホから投稿した面白い動画をリアルタイムでチェックできます。<br>アイドルの会員になって、掲示板で応援メッセージが送信できます。更に、最新オフ会情報やアイドルの日常、オフショットをいち早く入手！<br><br>アイドルは、ファンを集めるコミュニティを作って夢を叶えます！Groupyで動画を投稿して、「公開」か「会員のみ」のプライバシー設定してファンにシェアできます。ファンから有力な応援をもらい、ランキングの上位に入って注目度を上げましょう！</p>
